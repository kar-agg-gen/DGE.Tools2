...
test_that('runEdgeRNorm: runEdgeRNorm()', {
    ...
    runEdgeRNorm_one_test <- runEdgeRNorm(DGEobj1_minus_DGElist, plotFile = FALSE)
    ...
    runEdgeRNorm_two_test <- runEdgeRNorm(DGEobj1_minus_DGElist, normMethod = "RLE", plotFile = FALSE)
